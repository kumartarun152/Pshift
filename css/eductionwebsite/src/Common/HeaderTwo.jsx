...
function HeaderTwo() {
    ...
    let currentPath=currentUrl.pathname.split("/")[1]
    ...
    return (
        ...
        <li>
        <Link to={'/'} className={` ${currentPath=="" ? 'text-red-900' : '' } block py-2 pr-4 pl-[50px]  rounded bg-primary-700 lg:bg-transparent lg:p-0 `} aria-current="page">Home</Link>
                    </li>
                    <li>
                    <Link to={'/courses'} className={` ${currentPath=="courses" ? 'text-red-900' : '' } block py-2 pr-4 pl-[50px]  rounded bg-primary-700 lg:bg-transparent lg:p-0 `} aria-current="page">Courses123</Link>
                    </li>
        <li>
